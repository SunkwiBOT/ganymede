...
var (
	...
	NotificationsColumns = []*schema.Column{
		...
		{Name: "trigger_live_ended", Type: field.TypeBool, Default: false},
		...
		{Name: "live_ended_template", Type: field.TypeString, Size: 4096, Default: "⚫ {{channel_display_name}} is offline."},
